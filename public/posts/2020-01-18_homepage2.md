...
> Live: [https://dipsywong98.github.io](https://dipsywong98.github.io)
> Repo: [https://github.com/dipsywong98/dipsywong98.github.io](https://github.com/dipsywong98/dipsywong98.github.io)
...
![Homepage of dipsyland](https://i.imgur.com/OKBKjZp.png)
...
1. My first generation website is too _dirty_
    ...
    2. It requires a _logo for each work_ which I don't have time to make
        --  lots of default logo
        --  my site looks ugly and boring.
    3. It requires me _manually maintain_ a json file to display the list of works and notes and the content needs to be _embedded inside the json file_
...
![First dipsyland has many duplicated icons](https://i.imgur.com/fxc9ImO.png)
